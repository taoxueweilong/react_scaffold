...
class Index extends Component {
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      ...
      let medicineArr = dataSource.map((item, index) => {
        ...
        item.itemname = item.orderSuitname;
  ...
  render () {
    ...
    return (
      <div>
        <BasePop visible={visiblePop} title='新增西医治疗单' onClose={() => this.handlePopClose()}>
...
const WesternMedicine = Form.create()(Index);
