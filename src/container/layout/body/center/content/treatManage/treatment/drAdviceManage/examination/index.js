...
class Index extends Component {
  ...
  render () {
    ...
    return (
      <div>
        <BasePop visible={visiblePop} title='新增检验申请单' onClose={() => this.handlePopClose()}>
          ...
          <div style={styles.bodyTop} onClick={()=>{this.hidePop()}}>
              <Form className='customForm not-draggable' id='form'>
                        ...
                        <div>
                          {
                            tagData.map((item, index) => {
                              return (
                                ...
                                style={styles.tag}>{item.orderSuitname}
                                </Tag>
                              )
                            })
                          }
                ...
                >
                  ...
                  <Table.Column title="检验项/检验明细项" dataIndex="medicalname" />
                  <Table.Column title="执行科室" dataIndex="deptname" />
                  <Table.Column title="部位或送检物" dataIndex="number" />
                  <Table.Column title="数量" dataIndex="price" />
                  <Table.Column title="金额" dataIndex="unitprice" />
...
const Examination = Form.create()(Index);
