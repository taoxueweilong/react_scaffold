...
export default class AddIllBySymptom extends Component {
  ...
  render() {
    ...
    return (
      <Semicircle id='symptom' onKeyDown={this.handleEnterPress} onFocus={()=>{console.log('获取焦点')}} icon={icon} autofocus='autofocus' displayed={this.showResult} placeholder={placeholder}>
        {
          showResult?
          <Result>
            <Table
