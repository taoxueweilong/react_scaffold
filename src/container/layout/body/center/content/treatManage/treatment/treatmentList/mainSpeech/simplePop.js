...
import customBT from 'components/antd/style/button.css';
    ...
    <div>
      {
        ...
        <Container onKeyDown={this.handleEnterPress}>
          <Body>
            ...
            <Row>
              <Col span={6} offset={5}>
                <Button type="primary" className='semicircle' onClick={this.handleOK}>
                确定
                </Button>
              </Col>
              <Col span={6} offset={2}>
                <Button type="primary" className='cancel' onClick={this.handleClose}>
                取消
                </Button>
              </Col>
            </Row>
...
@作者：姜中希
@日期：2018-06-28
@描述：自定义一个简单弹框组件，使用方法见src\component\popout\mainSuit_input.js
*/
