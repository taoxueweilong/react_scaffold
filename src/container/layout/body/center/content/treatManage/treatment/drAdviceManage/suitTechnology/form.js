...
class Index extends Component {
  ...
  render () {
    ...
    return (
      <div>
        <BasePop visible={visiblePop} title='新增中医适宜技术治疗单' onClose={() => this.handlePopClose()}>
          ...
          <div style={styles.bodyTop} onClick={()=>{this.hidePop()}}>
              <Form className='customForm not-draggable' id='form'>
                ...
                >
                  ...
                  <Table.Column title="治疗项/治疗明细" dataIndex="orderSuitname" />
                  <Table.Column title="执行科室" dataIndex="deptname" />
                  <Table.Column title="数量/单位" dataIndex="count" />
...
const SuitTechnology = Form.create()(Index);

export default SuitTechnology;
