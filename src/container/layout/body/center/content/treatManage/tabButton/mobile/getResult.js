...
export default class GetResult extends Component {
  ...
  getResultsData(){
    ...
    let params = {
        ...
        function success(res){
          that.setState({
            scoreChart: res.scoreChart,//echart数据
  ...
  render() { 
    let {url, status, yearSeven, yearEight, bodyType, performance, diet, motion, reminder, lifeWay, newData} = this.state;
    return (
      <div style={styles.borderHeight}>
        <div style={styles.evaluationResultReport}>
            <Row type="flex" justify="start">
                ...
                <Col xs={6} sm={6}> 
                  <div onClick={this.handClickTestAgain.bind(this)}>
        ...
        <div>
          ...
          <Row type="flex" justify="start">
            <Col xs={24} sm={24}> 
              <div>
                <p style={styles.message}>测评日期：<span style={styles.date}>2018-03-31 09:34:45</span></p>
              </div>    
            </Col>
          </Row>
        </div>
