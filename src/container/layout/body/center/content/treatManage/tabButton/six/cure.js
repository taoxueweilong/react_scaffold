...
class Index extends Component {
  ...
  componentDidMount(){//患者是否存在 0或者1
    //let cardtype = window.cardtype;
    //let cardno = window.cardno;
    let params = {
      type: 'GET',
      url: 'healthcabin/infomanage/qrcode.zb',
      contentType: '',
            ...
            <div className="borderStyle">
              ...
              <div className="ewmOne">
                <div className="message">
                  ...
                  <br/>
                  <Button type="primary" size="large" className="sendMessage" onClick={this.handClick}>开始问答测评</Button>
                </div>
              </div>
            </div>
          </Col>
