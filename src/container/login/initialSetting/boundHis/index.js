  ...
  render() {
    ...
    return (
      <div>
        ...
        <Footer>
          <Button type="primary" className='middle' onClick={this.handleClick}>确认并下一 步</Button>
          <Button className='cancel middle' type="primary" onClick={()=>{this.unfinishedTip.handleOpen()}}>取消</Button>
        </Footer>
